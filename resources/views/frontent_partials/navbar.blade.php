...
async function translatePage(fromLang, toLang) {
    const walker = document.createTreeWalker(document.body, NodeFilter.SHOW_TEXT, {
        acceptNode: function(node) {
            ...
            return (
                ...
                !['SCRIPT', 'STYLE', 'NOSCRIPT', 'IFRAME'].includes(parent.nodeName) // ignore code/script
    ...
    try {
        const response = await fetch('/translate-api', {
            ...
            body: JSON.stringify({ text: joinedText, from: fromLang, to: toLang })
        });
