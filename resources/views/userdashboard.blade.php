    ...
    <div class="main-content">
      ...
      <div class="content">
        ...
        <div class="css-nh1rq9">
          <img src="{{ asset('images/250bd1a1701e4393407a4783b2e502bf.svg') }}"
        ...
        <div id="toggle-content1">
          <div class="before">
            ...
            <div class="button">
              ...
              <svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Incomplete">
                <path d="M12.705 4.705a.997.997 0 00-1.41 1.41L16.17 11H5a1 1 0 100 2h11.17l-4.876 4.885a.997.997 0 001.411 1.41L20 12l-7.295-7.295z"
                      fill="white"></path>
              </svg>
            </div>
          </div>
        ...
        <div class="dropdown-container">
          ...
          <div id="toggle-content" class="hidden">
            <a href="{{ route('usersearchProgram') }}"><button class="program">Find A Program</button></a>
            <div class="content2">
