...
<?php $__env->startSection('title', 'EduX | Home '); ?>
<?php $__env->startSection('content'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('css/newhome.css')); ?>">
    ...
    <section class="hero-bannerr">
        <div class="hero-content-home">
            ...
            <div class="buttons-home">
                <form action="<?php echo e(route('search')); ?>" method="GET" class="study-search-form-row">
                    <!-- Input Field -->
    ...
    <section class="cards-home">
        <div class="card-home">
            <img src="<?php echo e(asset('images/home3.png')); ?>" alt="Card 1">
        </div>
        <div class="card-home">
            <img src="<?php echo e(asset('images/middle-home.jpg')); ?>" alt="Card 2">
        </div>
        <div class="card-home">
            <img src="<?php echo e(asset('images/home2.png')); ?>" alt="Card 3">
        </div>
    </section>
    ...
    <section class="section">
        <div class="image-stack">
            <img src="<?php echo e(asset('images/home6.png')); ?>" alt="Front Image">
            <img src="<?php echo e(asset('images/home2-2.png')); ?>" alt="Back Image">
        </div>
...
<?php echo $__env->make('frontent.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\Documents\GitHub\edux_bloom\resources\views/home.blade.php ENDPATH**/ ?>