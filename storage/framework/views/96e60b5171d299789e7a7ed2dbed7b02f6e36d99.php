...
<?php $__env->startSection('title', 'EduX | Student Login'); ?>
<?php $__env->startSection('content'); ?>

    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css" />
    <link rel="stylesheet" href="<?php echo e(asset('css/loginfrontend.css')); ?>">
    ...
    <div class="main-container">
            ...
            <div class="login-container">
                <div class="card-login">
                    ...
                    <form id="loginForm" aria-label="Student Login Form">
                        <img src="<?php echo e(asset('images/old_edu-x white.png')); ?>" alt="Edu-X Logo" height="70" width="75" />
                        <br>
                        ...
                        <button type="button" class="buttn" id="loginButton">Log In</button>
                    </form>
                    ...
                    <div class="social-buttons">
                        <button class="btnnn"><a href="<?php echo e(route('google.login')); ?>" aria-label="Google" target="_blank" id="google">
                                    <i class="fab fa-google"></i>
                                Log In with Google</a></button>
                        <button class="btnnn"><i class="fab fa-apple"></i> Log In with Apple</button>
                        <button class="btnnn"><a href="<?php echo e(url('/auth/facebook')); ?>" aria-label="Google" target="_blank" id="google"><i class="fab fa-facebook"></i> Log In with Facebook </a></button>
                    </div>
        ...
        <!-- Right: Illustration -->
        <div class="login-img">
            <img src="<?php echo e(asset('images/login-page (1).png')); ?>" alt="Login Illustration" />
        </div>
    </div>
...
<?php echo $__env->make('frontent.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\Documents\GitHub\edux_bloom\resources\views/student_login.blade.php ENDPATH**/ ?>