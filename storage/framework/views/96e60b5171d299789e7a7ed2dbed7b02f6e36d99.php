            ...
            <div class="login-container">
                <div class="card-login">
                    ...
                    <form id="loginForm" aria-label="Student Login Form">
                        <img src="<?php echo e(asset('images/old_edu-x white.png')); ?>" alt="Edu-X Logo" height="70"
                            width="75" />
                        <br>
                    ...
                    <div class="social-buttons">
                        <button id="google-logo" class="btnnn"><a href="<?php echo e(route('google.login')); ?>" aria-label="Google"
                        ...
                        <button id="facebookk" class="btnnn"><a href="<?php echo e(url('/auth/facebook')); ?>" aria-label="Google"
