...
<nav class="navbar navbar-expand-lg">
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="<?php echo e('/'); ?>">
            <img src="<?php echo e(asset('images/edu-x white.png')); ?>" alt="Edu-X Logo" height="70" width="70"
                class="logo-border">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto">
                <li class="nav-item">
                    <a class="nav-link <?php echo e(Route::is('student') ? 'active' : ''); ?>"
                        href="<?php echo e(route('student')); ?>">Students</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(Route::is('institutions') ? 'active' : ''); ?>"
                        href="<?php echo e(route('institutions')); ?>">Parents</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(Route::is('search') ? 'active' : ''); ?>" href="<?php echo e(route('search')); ?>">Program &
                        Pathways</a>
                </li>

                <!-- Hover Dropdown -->
                <li class="nav-item dropdown-hover">
                    <a class="nav-link <?php echo e(request()->is('blogs-pages') || request()->is('youngleaders') || request()->is('events') || request()->is('contactus') ? 'active' : ''); ?>"
                        href="#">
                        Resource Center <i class="fas fa-chevron-down"></i>
                    </a>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item <?php echo e(request()->is('blogs-pages') ? 'active' : ''); ?>"
                                href="/blogs-pages">Edu-X Blog</a></li>
                        <li><a class="dropdown-item <?php echo e(request()->is('youngleaders') ? 'active' : ''); ?>"
                                href="/youngleaders">Edu-X
                                Young Leaders</a></li>
                        <li><a class="dropdown-item <?php echo e(request()->is('events') ? 'active' : ''); ?>"
                                href="/events">Parent Resources</a></li>
                        <li><a class="dropdown-item <?php echo e(request()->is('contactus') ? 'active' : ''); ?>"
                ...
                <div class="language-option">
                    <!-- <div class="language-switcher">
                        <a href="<?php echo e(route('change.lang', 'en')); ?>"
                            class="lang-option <?php echo e(app()->getLocale() === 'en' ? 'active' : ''); ?>">EN</a>
                        <span class="lang-divider">|</span>
                        <a href="<?php echo e(route('change.lang', 'fr')); ?>"
                            class="lang-option <?php echo e(app()->getLocale() === 'fr' ? 'active' : ''); ?>">FR</a>
                    </div> -->
            ...
            <div class="auth-section">
                ...
                <?php else: ?>
                    ...
                    <div class="auth-buttons">
                        <a href="<?php echo e(route('student-login')); ?>" class="login-link">Login</a>
                        <a href="<?php echo e(route('student-register')); ?>" class="register-button">Register</a>
                    </div>
                <?php endif; ?>
            </div>
...
<?php /**PATH C:\Users\DELL\Documents\GitHub\edux_bloom\resources\views/frontent_partials/navbar.blade.php ENDPATH**/ ?>