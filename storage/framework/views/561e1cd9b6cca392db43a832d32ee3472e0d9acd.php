...
<?php $__env->startSection('title', 'EduX | Student Registration'); ?>
<?php $__env->startSection('content'); ?>
    ...
    <div class="page">
        <div class="imag">
            <img src="<?php echo e(asset('images/registerpage-Photoroom.png')); ?>" alt="Register Image" />
        </div>
    ...
    <script>
        ...
        document.getElementById('student-register-form').addEventListener('submit', async function(e) {
            ...
            try {
                const response = await fetch('<?php echo e(url('/student/register')); ?>', {
                    method: 'POST',
                    headers: {
...
<?php echo $__env->make('frontent.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\Documents\GitHub\edux_bloom\resources\views/student_register.blade.php ENDPATH**/ ?>